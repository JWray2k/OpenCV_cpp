...
// referenced from https://github.com/opencv/opencv/blob/master/samples/cpp/lsd_lines.cpp
using namespace std;
using namespace cv;
...
int main(int argc, char** argv)
{
	cv::CommandLineParser parser(argc, argv,
		"{input   i|C:/Users/wray/Pictures/DragonAndBunnies/DragonsAndBunnies_5x5_ap3/dragons-01.png|input image}" // was ../data/building.jpg... interesting... this is where my input went...
