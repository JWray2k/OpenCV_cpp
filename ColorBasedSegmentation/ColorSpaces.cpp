...
// So I got this running, but the results are a tad strang with the 
...
- First we will see how to read an image in OpenCV and convert it into different color spaces and see what 
  new information do the different channels of each color space provide us.
...
// Code here - https://github.com/spmallick/learnopencv/tree/master/ColorSpaces
...
int main(int argc, char **argv)
{
	...
	Referenced from: http://answers.opencv.org/question/58078/reading-a-sequence-of-files-within-a-folder/
	*/
	...
	if (argc > 1)
		nImages = atoi(argv[1]);
	char filename[40];
	sprintf(filename, "C:/Users/wray/Pictures/images/rub%02d.jpg", image_number%nImages);
