...
int main(int argc, char** argv)
{
	...
	Mat img_1 = imread("C:/Users/wray/Pictures/FeatureToDetect.png", IMREAD_GRAYSCALE); //Need to find an image to Identify in another - argv[1]
	Mat img_2 = imread("C:/Users/wray/Pictures/DragonAndBunnies/DragonsAndBunnies_5x5_ap3/dragons-01.png", IMREAD_GRAYSCALE); //crop of first imag - argv[2]
