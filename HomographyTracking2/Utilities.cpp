...
/*
Recieving linking errors (LNK2019) with the following:
	- cv::warpPerspective()	referenced in function "void __cdecl CalibrateVideoStream(class cv::VideoCapture)"
	- cv::circle() referenced in function "void __cdecl CalibrateVideoStream(class cv::VideoCapture)"
	- cv::GaussianBlur() referenced in function "class cv::Mat __cdecl SmoothImage(float,class cv::Mat const &)"
	- cv::Scharr() referenced in function "void __cdecl ComputeImageDerivatives(class cv::Mat const &,class cv::Mat &,class cv::Mat &)" 
	- cv::goodFeaturesToTrack() referenced in function "class StructOfArray2d<int> __cdecl CreateAnisotropicGridOfControlPoints(class cv::Mat &,unsigned int,float,float)"
	- cv::resize() referenced in function "void __cdecl AcquireVGAGrayscaleImage(class cv::VideoCapture &,class cv::Mat &,class cv::Mat &)"
	- cv::cvtColor() referenced in function "void __cdecl AcquireVGAGrayscaleImage(class cv::VideoCapture &,class cv::Mat &,class cv::Mat &)"
	- cv::line() referenced in function "void __cdecl AugmentFrameWithQuadrilater(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,class StructOfArray2d<int> const &,class cv::Mat &)"
	- cv::putText() referenced in function "void __cdecl WriteResultsOnImage(class cv::Mat &,struct AlignmentResults const &,int,enum OptimizationType)"
*/
