// Already had this under imfill name
// https://github.com/spmallick/learnopencv/blob/master/Holes/imfill.cpp
...
{
	// Read image
	Mat im_in = imread("C:/Users/wray/Pictures/nickel.jpg", IMREAD_GRAYSCALE);
